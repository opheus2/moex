<template>
    <div>
                ...
                <div class="d-flex justify-content-between w-93 sm-block" style="margin-top:0; margin-bottom:0;">
                    <div class="pl-0 d-flex child">
                        ...
                        <div class="button-group">
                            <select2 v-model="selectedPaymentMethod" :options="paymentMethods.map(method => {return {id: method.id, text: method.name, selected:method.name.includes('Cash Deposit') } })" />
                        </div>
        ...
        <div class="d-flex justify-content-center security">
            <div class="row w-93">
