    ...
    <div class="contact-card">
      ...
      <form>
        <div class="row">
          ...
          <div class="col-md-12">
            <textarea class="con-text form-control" rows="8"> Message</textarea>
          </div>
          <div class="col-md-12">
            <a class="text-color btn btn-purple btn-lg btn-send" href="#">Send</a>
          </div>
        </div>
      </form>
    </div>
  ...
  <div class="contact-col right">
    <div class="w-100" >
      <div class="contact-card">
        ...
        <p class="details">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
      </div>
      <div class="contact-card">
        <div class="d-flex justify-content-center">
          <div class="icon-card d-flex justify-content-center align-items-center">
      ...
      <div class="contact-card">
        ...
        <p class="details">XXXXXXXXXXXXX, XXXXXXXXXXXXXX, XXXXXXXXXXXXX</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-md-5">
        <div class="row">
            <div class="col-md-12 ico-bg">
                <img src="images/location.svg" class="myimage ico">
        ...
        <div class="row">
            <div class="col-md-12 ico-bg">
                <img src="images/email.svg" class="myimage ico">
        ...
        <div class="row">
            <div class="col-md-12 ico-bg">
                <img src="images/phone.svg" class="myimage ico">
