...
<div class="container-fluid">
    <div class="row" style="margin-top:52px">
        <div class="col-md-6">
            <h4 class="myown">About MyOwn Exchange</h4>
    ...
    <div class="row" style="margin-top:52px">
        <h4 class="trade">Trade Offers</h4>
    </div>
    <div class="row">
        <div class="col-md-6">
            <h5 class="buy-cash">Buy Bitcoins with cash</h5>
        </div>
        <div class="col-md-6 button-group">
            ...
            <button class="btn btn-nig">In Nigeria</button>
        </div>
    </div>
    <div class="row">
...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="col-md-3 text-center">
            <img class="myimage" src="{{ asset('images/ssl.png') }}">
        ...
        <div class="col-md-3">
            <img class="transactions myimage" src="{{ asset('images/transaction.png') }}">
            <h4 class="ssl-text-head">Transactions</h4>
            <h6 class="ssl-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris auctor imperdiet tincidunt.</h6>
        </div>
        <div class="col-md-3">
            <img class="myimage" src="{{ asset('images/bitcoin.png') }}"> 
            <h4 class="ssl-text-head">Save</h4>
            <h6 class="ssl-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris auctor imperdiet tincidunt.</h6>           
        </div>
        <div class="col-md-3">
            <img  class="transactions myimage" src="{{ asset('images/time.png') }}">
...
<div class="container-fluid" style="margin-top: 67px;">
    <div class="row">
        <div class="col-md-6">
            <img src="{{ asset('images/convo.png') }}" class="responsive">
        </div>
        <div class="col-md-6" >
...
<div class="container grid-3 ">
        <div class="col-md-3">
            <img src="{{ asset('images/disney.svg') }}">
        </div>
        <div class="col-md-3">
            <img src="{{ asset('images/crit.svg') }}">
        </div>
        <div class="col-md-3">
            <img src="{{ asset('images/init.svg') }}">
        </div>
        <div class="col-md-3">
            <img src="{{ asset('images/wil.svg') }}">
        </div>
</div>

<div class="container-fluid join">
    <div class="col-md-6">
        <span class="us">Join Us</span><br>
