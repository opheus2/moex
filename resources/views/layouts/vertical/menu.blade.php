<app-menu inline-template>
    <div data-intro="Quick links to navigte through the dashboard" data-step="1" class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                ...
                @can('resolve trade dispute')
                    ...
                    <li class="nav-item">
                        <a href="{{route('moderation.trades.index')}}">
                            ...
                            @else
                                <span class="badge badge-pill badge-default badge-success float-right badge-glow">
                                    {{$dispute}} {{__('dispute')}}
                                </span>
                            @endif
                        </a>
