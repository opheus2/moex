                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="card">
                        <div class="card-header text-center border-top-success">
                            <h1>
                                {{__('You get coins in exchange for...')}}
                            </h1>
                            <h6>
                                {{__('Want to sell coin?')}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="bs-callout-primary callout-border-left mt-1 p-1">
                                                ...
                                                <p class="card-text">
                                                    {{__('Current market price is')}} <b>@{{ formatAmount(coinPrice) }}</b>. <br/>
                                                    {{__('I am selling')}} @{{ payment_method }} {{__('for')}}
                                                    <b>@{{ formatAmount(totalPrice) }}</b> {{__('per')}} <b>@{{ coins[coin] }}</b>.
                                                </p>

                                                <p class="card-text">
                                                    {{__('I will get')}} <b>@{{ totalPercent }}</b>% {{__('of')}}
                                                    <b>@{{ payment_method }}</b>. <br/>
                                                    {{__('I will')}} <span v-if="profit_margin >= 0">{{__('earn')}}</span>
                                                    <span v-else>{{__('lose')}}</span> <b>@{{ formatAmount(netAmount)}}</b>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" v-text="coin"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
